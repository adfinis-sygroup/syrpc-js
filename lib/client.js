...
var SyRPCClient = (function (_base$SyRPCBase) {
  ...
  function SyRPCClient() {
    _classCallCheck(this, SyRPCClient);

    _get(Object.getPrototypeOf(SyRPCClient.prototype), "constructor", this).apply(this, arguments);
  }
  ...
  _createClass(SyRPCClient, [{
    ...
    value: function get_result(result_id) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var result_queue = _this.assert_result_queue(hash_id);
        if (timeout !== null) {
          setTimeout(function () {
        ...
        tag = _this.channel.consume(result_queue, function (msg) {
